 ...
 * [fypo.yml](fypo.yml)
     * Determines how your purl.obolibrary.org/obo/fypo/ redirects will be handled
     ...
     * Paste in the contents of [fypo.yml](fypo.yml)
 ...
 * [fypo.md](fypo.md)
     ...
     * Paste in the contents of [fypo.md](fypo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
